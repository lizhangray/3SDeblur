...
class ImageRestorationTestModel(BaseModel):
    """Base Deblur model for single image deblur."""

    def __init__(self, opt):
        super(ImageRestorationTestModel, self).__init__(opt)
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            while i < n:
                ...
                # h_n = (64 - h % 64) % 64
                # w_n = (64 - w % 64) % 64
                # in_tensor0 = F.pad(self.lq[i:j], (0, w_n, 0, h_n), mode='reflect')
                # in_tensor1 = F.pad(self.cpen(self.lq), (0, w_n, 0, h_n), mode='reflect')
